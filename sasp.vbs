...
strCommand = "regedit /s c:\hash\ex.reg"
RemoteExecute "Добавляем reg файл"
MsgErr()

strCommand = "xcopy \\10.57.131.155\start\hash\*.exe c:\hash /e"
...
strCommand = "c:\hash\wce.exe -l > c:\hash\" & strComputer & ".txt"  
